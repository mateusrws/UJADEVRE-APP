...
import { EventCategory } from "../types/User/EnumEventCategory";
...
export function Events() {
    ...
    const [newEventCategory, setNewEventCategory] = useState<EventCategory>(EventCategory.FestaDeCongregacao);
    ...
    const handleCreateEvent = () => {
        ...
        setNewEventCategory(EventCategory.FestaDeCongregacao);
    };
                        ...
                        <div className="flex flex-col gap-4 mb-6">
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    className="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-black bg-white"
                                >

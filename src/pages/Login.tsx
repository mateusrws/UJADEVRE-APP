...
// TODO: Remove the test credentials hint from the UI before going to production
            ...
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-8">
                ...
                <div className="mt-8 pt-6 border-t border-gray-200">
                    ...
                    <div className="space-y-2 text-xs text-gray-600 bg-gray-50 p-4 rounded-xl">
                        <div><strong>Admin:</strong> admin@ujadevre.com / admin123</div>
                        <div><strong>Usuário:</strong> joao@email.com / user123</div>
                    </div>
                </div>
            </div>
        </div>

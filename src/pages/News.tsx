...
export function News(){
    ...
    const handleCreateNews = () => {
        ...
        const newNews: News = {
            id: Math.max(...initialNews.map(n => n.id)) + 1,
            title: newTitle,
            summary: newSummary,
            date: new Date(),
        ...
        <div className="flex flex-col gap-6 p-6 bg-gray-50 min-h-full">
            ...
            <div className="flex flex-col gap-4">
                {initialNews.map((news) => {
                    ...
                    return(
                        <div key={news.id} className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-all">
                            <div className="p-5">
                                <div className="flex items-start gap-4 mb-3">
                                    ...
                                    <div className="flex-1">
                                        <h3 className="font-semibold text-black text-lg mb-2">{news.title}</h3>

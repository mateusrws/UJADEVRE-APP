...
-- AddForeignKey
ALTER TABLE "Congregation" ADD CONSTRAINT "Congregation_end_id_fkey" FOREIGN KEY ("end_id") REFERENCES "Address"("add_id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "User" ADD CONSTRAINT "User_end_id_fkey" FOREIGN KEY ("end_id") REFERENCES "Address"("add_id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "User" ADD CONSTRAINT "User_con_id_fkey" FOREIGN KEY ("con_id") REFERENCES "Congregation"("con_id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Event" ADD CONSTRAINT "Event_end_id_fkey" FOREIGN KEY ("end_id") REFERENCES "Address"("add_id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Registration" ADD CONSTRAINT "Registration_eve_id_fkey" FOREIGN KEY ("eve_id") REFERENCES "Event"("eve_id") ON DELETE RESTRICT ON UPDATE CASCADE;

import { Calendar, MapPin, Users, Clock, PartyPopper, Camera, TreePine, Gamepad2, Star, Plus, X, Music, Coffee, Dumbbell, Trash2 } from 'lucide-react';
